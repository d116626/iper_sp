...
class IcmsSpider(scrapy.Spider):
    ...
    def parse_months(self,response):
        # cols = response.xpath('//*[@id="ConteudoPagina_tbRepasse"]/tr//table//th/b').extract()
        # months  = response.xpath('//*[@id="ConteudoPagina_tbRepasse"]/tr//table/tr/td/font//font/text()').extract()

        # products = response.xpath('//*[@color="Red"]/a/font').extract()
        ...
        # for row in table[:6]:
        #     j+=1
        #     month = row.xpath('//*[@bgcolor="#DDDDDD"]/font')
        #     # value = i.xpath('//*[@color="Red"]/a/font').extract()
